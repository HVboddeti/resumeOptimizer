...
function App() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await fetch("https://b1qyocwv91.execute-api.us-east-1.amazonaws.com/start/resume-processing-lambdahttps://es744e7qoi.execute-api.us-east-1.amazonaws.com/new", {
                method: "POST",
                body: formData
            });
